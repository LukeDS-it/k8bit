...
class MathSpec {
    ...
    @Test
    fun `mv should set the value of registere x to the value of register y`() {
    ...
    @Test
    fun `add should set register x to x + y with no carry`() {
        val subject = Chip8Processor()
        subject.v[0] = 0b0010010101101011
        subject.v[1] = 0b0110000110000010
    ...
    @Test
    fun `add should set register x to x + y with carry`() {
        val subject = Chip8Processor()
        subject.v[0] = 0b0010010101101011
    ...
    @Test
    fun `invSub should set register x to y - x without borrow`() {
        val subject = Chip8Processor()
    ...
    @Test
    fun `invSub should set register x to y - x with borrow`() {
        val subject = Chip8Processor()
    ...
    fun `sll should shift left y by 1 into x returning the previous msb`() {
        val subject = Chip8Processor()
        subject.v[0] = 0b1000000100000001
        val expected = 0b0000001000000010
